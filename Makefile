##
 ...
 #  date        06/06/2016
 #  brief       Makefile for Physocal Web Beacon project
##
...
PROJECT_NAME := pw-beacon
NRFJPROG_PATH := ./script
SDK_PATH := /opt/nordic-sdk9
...
$(abspath $(SDK_COMPONENTS_PATH)/ble/ble_radio_notification/ble_radio_notification.c)\
...
INC_PATHS += -I$(abspath $(SDK_COMPONENTS_PATH)/ble/ble_radio_notification/)
...
default: clean nrf51822_preset

#building all targets
all: clean
	$(NO_ECHO)$(MAKE) -f $(MAKEFILE_NAME) -C $(MAKEFILE_DIR) -e cleanobj
	$(NO_ECHO)$(MAKE) -f $(MAKEFILE_NAME) -C $(MAKEFILE_DIR) -e nrf51822_preset
...
nrf51822_preset: $(BUILD_DIRECTORIES) $(OBJECTS)
